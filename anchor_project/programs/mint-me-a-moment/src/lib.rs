...
declare_id!("7XL4LLTmwHYHCDe8FNpcKFuoeV1ftzczXHZuji3of4kC");

#[program]
pub mod mint_me_a_moment {
    use super::*;
    ...
    pub fn tip(
        ...
        require!(amount > 0, MintMeAMomentError::InvalidAmount);

        require!(
            ctx.accounts.tipper.lamports() >= amount,
            MintMeAMomentError::InsufficientBalance
        );
